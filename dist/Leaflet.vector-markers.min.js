    ...
    (function (c, a, b) {
        ...
        L.VectorMarkers.Icon = L.Icon.extend({
            options: {
                ...
                h.innerHTML = '<svg width="32px" height="52px" viewBox="0 0 32 52" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="' + g + '" fill="' + d.markerColor + '"></path>' + e + "</svg>";
